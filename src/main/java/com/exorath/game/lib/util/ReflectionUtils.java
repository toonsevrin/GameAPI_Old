...
public final class ReflectionUtils {
     ...
     *             (this should not occur since it searches for a constructor
     ...
     *             If the types of the arguments do not match the parameter
     *             types of the method
     *             (this should not occur since it searches for a method with
     *             the types of the
     *             arguments)
     * @throws InvocationTargetException
     ...
     *             it searches for a field with the given name in the class of
     *             the object)
     * @throws IllegalAccessException
     *             If the desired field cannot be accessed
     * @throws NoSuchFieldException
