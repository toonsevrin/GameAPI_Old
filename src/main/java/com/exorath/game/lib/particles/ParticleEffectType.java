...
public enum ParticleEffectType {
     ...
     * 0
     * <li>Only the motion on the y-axis can be controlled, the motion on the x-
     * and z-axis are
    ...
    private static boolean isColorCorrect(ParticleEffectType effect, ParticleColor color) {
        return (effect == SPELL_MOB || effect == SPELL_MOB_AMBIENT || effect == REDSTONE)
                && color instanceof OrdinaryColor || effect == NOTE
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount,
                ParticleEffectType.isLongDistance(center, players), null).sendTo(center,
                        players);
    }
     ...
     *             water and none is at
     *             the center location
     * @see ParticlePacket#ParticlePacket(ParticleEffectType, Vector, float,
    ...
    public void display(Vector direction, float speed, Location center, List<Player> players)
        ...
        new ParticlePacket(this, direction, speed, ParticleEffectType.isLongDistance(center, players), null)
     ...
     *             incorrect
     * @see ParticlePacket#ParticlePacket(ParticleEffectType, ParticleColor,
     *      boolean)
     * @see ParticlePacket#sendTo(Location, double)
     */
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount,
                ParticleEffectType.isLongDistance(center, players), data).sendTo(center,
                        players);
    }
     ...
     * a determined
     * direction and is only visible for all players within a certain range in
     * the world of @param
     * center
     * 
     * @param data
    ...
    public void display(ParticleData data, Vector direction, float speed, Location center, List<Player> players)
        ...
        new ParticlePacket(this, direction, speed, ParticleEffectType.isLongDistance(center, players), data)
                .sendTo(center, players);
    }
     ...
     * <p>
     * This class is part of the <b>ParticleEffectType Library</b> and follows
     ...
     * {@link ParticleEffectType#ITEM_CRACK},
     * {@link ParticleEffectType#BLOCK_CRACK} and
     * {@link ParticleEffectType#BLOCK_DUST}
     * <p>
     * This class is part of the <b>ParticleEffectType Library</b> and follows
     * the same usage conditions
     * 
    ...
    /**
     * Represents the item data for the {@link ParticleEffectType#ITEM_CRACK}
     * effect
     * <p>
     * This class is part of the <b>ParticleEffectType Library</b> and follows
     * the same usage conditions
    ...
    /**
     * Represents the block data for the {@link ParticleEffectType#BLOCK_CRACK}
     * and
     ...
     * {@link ParticleEffectType#SPELL_MOB},
     * {@link ParticleEffectType#SPELL_MOB_AMBIENT},
     * {@link ParticleEffectType#REDSTONE} and
     ...
     * Represents the color for effects like
     * {@link ParticleEffectType#SPELL_MOB},
     * {@link ParticleEffectType#SPELL_MOB_AMBIENT} and
     * {@link ParticleEffectType#NOTE}
     * <p>
     * This class is part of the <b>ParticleEffectType Library</b> and follows
     * the same usage conditions
    ...
    public static final class ParticlePacket {
         ...
         * @see #initialize()
         */
        public ParticlePacket(ParticleEffectType effect, float offsetX, float offsetY, float offsetZ, float speed,
                int amount, boolean longDistance,
         ...
         */
        public ParticlePacket(ParticleEffectType effect, Vector direction, float speed, boolean longDistance,
                ParticleData data)
                        throws IllegalArgumentException {
         ...
         * {@link #playerConnection} and
         * {@link #sendPacket} and sets {@link #initialized} to
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ParticlePacket.version = Integer
                ...
                Class<?> packetClass = ReflectionUtils.PackageType.MINECRAFT_SERVER
                        .getClass(ParticlePacket.version < 7 ? "Packet63WorldParticles"
                                : "PacketPlayOutWorldParticles");
                ParticlePacket.packetConstructor = ReflectionUtils.getConstructor(packetClass);
                ParticlePacket.getHandle = ReflectionUtils.getMethod("CraftPlayer",
                        ReflectionUtils.PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
                ParticlePacket.playerConnection = ReflectionUtils.getField("EntityPlayer",
                        ReflectionUtils.PackageType.MINECRAFT_SERVER, false,
                        "playerConnection");
                ParticlePacket.sendPacket = ReflectionUtils.getMethod(ParticlePacket.playerConnection.getType(),
                        "sendPacket",
            ...
            try {
                ...
                if (ParticlePacket.version < 8) {
                    ...
                    ReflectionUtils.setValue(this.packet, true, "a",
                            ParticlePacket.enumParticle.getEnumConstants()[this.effect.getId()]);
        ...
        public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException {
            ...
            try {
                ParticlePacket.sendPacket.invoke(
                        ParticlePacket.playerConnection.get(ParticlePacket.getHandle.invoke(player)), this.packet);
            } catch (Exception exception) {
         ...
         * this library
         * <p>
         * This class is part of the <b>ParticleEffectType Library</b> and
         * follows the same usage
         * conditions
         * 
         * @author DarkBlade12
         * @since 1.5
