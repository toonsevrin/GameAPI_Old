...
public final class ReflectionUtils {
     ...
     *             ClassNotFoundException If the desired target class with the specified name and
     ...
     *             If the types of the arguments do not match the parameter types of the constructor
     *             (this should not occur since it searches for a constructor with the types of the
     *             arguments)
     ...
     * @throws InstantiationException
     *             If you cannot create an instance of the desired target class due to certain
     *             circumstances
     * @throws IllegalAccessException
     *             If the desired constructor cannot be accessed due to certain circumstances
     * @throws IllegalArgumentException
     ...
     * @throws NoSuchMethodException
     *             If the desired method of the target class with the specified name and parameter
     ...
     * @throws NoSuchMethodException
     *             If the desired method of the desired target class with the specified name and
     ...
     * @throws IllegalArgumentException
     *             If the types of the arguments do not match the parameter types of the method
     *             (this should not occur since it searches for a method with the types of the
     *             arguments)
     * @throws InvocationTargetException
     *             If the desired method cannot be invoked on the target object
     * @throws NoSuchMethodException
     *             If the desired method of the class of the target object with the specified name
     *             and arguments cannot be found
     * @see #getMethod(Class, String, Class...)
     * @see DataType#getPrimitive(Object[])
     */
    public static Object invokeMethod( Object instance, String methodName, Object... arguments ) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
     ...
     *             If the desired method cannot be invoked on the target object
     * @throws NoSuchMethodException
     *             If the desired method of the target class with the specified name and arguments
     *             cannot be found
     * @see #getMethod(Class, String, Class...)
     * @see DataType#getPrimitive(Object[])
     */
    public static Object invokeMethod( Object instance, Class<?> clazz, String methodName, Object... arguments ) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
     ...
     */
    public static Field getField( String className, PackageType packageType, boolean declared, String fieldName ) throws NoSuchFieldException,
     ...
     * @see #getField(Class, boolean, String)
     */
    public static Object getValue( Object instance, Class<?> clazz, boolean declared, String fieldName ) throws IllegalArgumentException,
     ...
     * @return The value of field of the target object
     * @throws IllegalArgumentException
     *             If the target object does not feature the desired field (should not occur since
     ...
     * @see #getValue(Object, Class, boolean, String)
     */
    public static Object getValue( Object instance, boolean declared, String fieldName ) throws IllegalArgumentException, IllegalAccessException,
     ...
     * @see #getField(Class, boolean, String)
     */
    public static void setValue( Object instance, Class<?> clazz, boolean declared, String fieldName, Object value ) throws IllegalArgumentException,
            IllegalAccessException, NoSuchFieldException, SecurityException {
     ...
     * @see #setValue(Object, Class, boolean, String, Object)
     */
    public static void setValue( Object instance, boolean declared, String fieldName, Object value ) throws IllegalArgumentException,
            IllegalAccessException, NoSuchFieldException, SecurityException {
