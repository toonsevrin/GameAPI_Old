...
public class AdvancedTitle {
    ...
    public static enum JSONParam {
        ...
        STRIKETHROUGH,
        /**
         * Controls whether the text is randomised constantly or not. Default
         * false
         */
        OBFUSCATED;
    }
    ...
    public static class JSONPart {
        ...
        public String getJSONPart() {
            return "{text:'" + string + "',color:'" + color.name().toLowerCase() + "',bold:" + bold + ",italic:"
                    + italic + ",underlined:"
                    + underlined
     ...
     * @throws InstantiationException
     */
    public static void sendTitleAndSubTitle(Player player, String JSONtitle, String JSONsubtitle, Integer fadeIn,
            Integer stay, Integer fadeOut)
                    throws IllegalAccessException, IllegalArgumentException,
                    InvocationTargetException, NoSuchFieldException,
                    SecurityException, ClassNotFoundException, NoSuchMethodException, InstantiationException {
        if (player != null && JSONtitle != null && JSONsubtitle != null) {
            ...
            new NullPointerException("The vars: 'player', 'JSONtitle' and 'JSONsubtitle' musn't be null !")
                    .printStackTrace();
        }
    }

    private static void sendTitle(Player player, String JSONtitle, String JSONsubtitle, Integer fadeIn, Integer stay,
            Integer fadeOut)
                    throws IllegalAccessException, IllegalArgumentException,
                    InvocationTargetException, NoSuchFieldException,
                    SecurityException, ClassNotFoundException, NoSuchMethodException, InstantiationException {

        Field playerConnection = ReflectionUtils.getField("EntityPlayer", ReflectionUtils.PackageType.MINECRAFT_SERVER,
        ...
        Method getIChatBaseComponent = ReflectionUtils.getMethod("ChatSerializer",
                ReflectionUtils.PackageType.MINECRAFT_SERVER, "a", String.class);
        Method getHandle = ReflectionUtils.getMethod("CraftPlayer", ReflectionUtils.PackageType.CRAFTBUKKIT_ENTITY,
                "getHandle");
        ...
        sendPacket.invoke(playerConnection.get(getHandle.invoke(player)),
                instancePacket(packetConstructor, enum_titleaction.getEnumConstants()[0], JSONtitle_component, -1, -1,
                        -1));
        if (JSONsubtitle != null) {
            sendPacket.invoke(playerConnection.get(getHandle.invoke(player)),
                    instancePacket(packetConstructor, enum_titleaction.getEnumConstants()[1], JSONsubtitle_component,
                            -1, -1, -1));
        }
    }

    private static Object instancePacket(Constructor<?> packetConstructor, Object a, Object b, Object c, Object d,
            Object e)
