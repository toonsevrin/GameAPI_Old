...
public enum ColumnType {
    ...
    public static ColumnType getColumnType(String dataType){
        ...
        for(ColumnType type : ColumnType.values()){
            if(type.getDataType().equals(dataType)) return type;
        }
        return null;
    }
    ...
    public static ColumnType getColumnType(String dataType, int maxCharLength){
        ...
        for(ColumnType type : ColumnType.values()){
            ...
            if(type.getMaxCharLength() == maxCharLength && type.getDataType().equals(dataType)) return type;
        }
        return null;
    }
    ...
    public String getDataTypeStructured(){
        if(cappedLength && decimal) return name + "(" + cappedLength + "," + decimals + ")";
        if(cappedLength) return name + "(" + cappedLength + ")";
        if(decimal) return name + "(" + decimals + ")";
        return name;
    }
