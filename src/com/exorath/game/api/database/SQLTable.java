...
public class SQLTable {
    ...
    public SQLData getData(String key){
        ...
        ResultSet rs =  GameAPI.getSQLManager().executeQuery("SELECT * FROM " + name + " WHERE " + KEY  + "='" + key + "' LIMIT 1");
     ...
     * @param key Row key you want to insert or update
     * @param data Data you want to insert or update
     */
    ...
    public void addColumn(SQLColumn column){
        GameAPI.getSQLManager().executeQuery("ALTER TABLE " + name + " ADD " + column.getKey() + column.getType().getDataTypeStructured());
        loadColumn(column);
    }
    ...
    public void createRow(String key, SQLData data){
        ResultSet rs = GameAPI.getSQLManager().executeQuery("INSERT INTO " + name + " " + data.getValuesString() + ";");//create new row with data
        GameAPI.printConsole("Created row " + key + " in table " + name + " successfully.");
        //TODO: Add error reporting
    }

    /**
     * Update an already existing row
     * @param key Row you want to update.
    ...
    public void updateRow(String key, SQLData data){
        ...
        GameAPI.printConsole("Updated row " + key + " in table " + name + " successfully.");
        //TODO: Add error reporting
    }
    /**
    ...
    public void addColumn(String columnName, ColumnType type){
        GameAPI.getSQLManager().executeQuery("ALTER TABLE " + name + " ADD " + columnName + " " + type.getDataTypeStructured() + " UNIQUE;");

        GameAPI.printConsole("Added column " + columnName + " with type " + type.getDataTypeStructured() + " to table " + name + ".");
    }
