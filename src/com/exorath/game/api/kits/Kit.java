...
import com.exorath.game.api.events.*;
...
public abstract class Kit {
    ...
    public PurchasableItem getKitItem(GPlayer player) {
        ...
        return new PurchasableItem(getName(), getMaterial(), getDescription(), getUnlockRequirements(), player, false);
    }
    ...
    public ItemStack getKitSelectorItem(GPlayer player) {
        ItemStackBuilder builder = new ItemStackBuilder(getMaterial());
