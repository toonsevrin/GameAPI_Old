...
public class HUDManager implements Manager {
    ...
    public class PublicHUD implements GameListener {
        ...
        public void addActionBar(String key, HUDText text) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getActionBar().addText(key, text.clone()));
        }
        ...
        public void addTitle(String key, HUDText text) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getTitle().addText(key, text.clone()));
        }
        ...
        public void addSubtitle(String key, HUDText text) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getSubtitle().addText(key, text.clone()));
        }
        ...
        public void addBossBar(String key, HUDText text) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getBossBar().addText(key, text.clone()));
        }
        ...
        public void addScoreboard(String key, ScoreboardText text) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getScoreboard().addText(key, text.cloneSB()));
        }
        ...
        public void removeActionBar(String key) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getActionBar().removeText(key));
        }
        ...
        public void removeTitle(String key) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getTitle().removeText(key));
        }
        ...
        public void removeSubtitle(String key) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getSubtitle().removeText(key));
        }
        ...
        public void removeBossBar(String key) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getBossBar().removeText(key));
        }
        ...
        public void removeScoreboard(String key) {
            ...
            game.getManager(PlayerManager.class).getOnlinePlayers().forEach(gp -> gp.getHud().getScoreboard().removeText(key));
        }
        ...
        public void updateActionBar(String key, String text) {
            game.getManager(PlayerManager.class).getOnlinePlayers().stream().filter(gp -> gp.getBukkitPlayer() != null)
